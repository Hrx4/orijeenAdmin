...
const Admin = () => {
  ...
  return (
    <>
    {/* <Navbar/> */}
        <div style={{backgroundColor: 'rgba(22,34,57,0.95)' , height : "100vh", width:"100%" , display:"flex" , flexDirection:"column", justifyContent:"center" , gap:30, paddingTop:110 ,  paddingBottom:110}}>
