    ...
    return (
        <>
            <div>
                ...
                <div className="anocontact" style={{ padding: 20, position: "absolute", top: '38%', right: '5%', transform: 'translateY(-50%)', width: "20%" }}>
                ...
                <div>
                    ...
                    <table className="sdtable" style={{ width: "60%", overflowX: "scroll", overflowY: "scroll", height: "100vh", border:"none", marginLeft:"10px" }}>
                        <tbody>
                        <h2 
                        style={{padding: "10px", height:"65px", border:"2px solid black", marginTop:"15px", width:"200%", marginBottom:"-3px", backgroundColor:"#00ffff"}}>Basic Details</h2>
                            <tr style={{border:"2px solid black"}}>
                                <td style={{border:"2px solid black", padding:10, width:"50%", margin:0, fontWeight:"bold"}}>Enrollment No.</td>
                                <td style={{border:"2px solid black", padding:10, width:"50%"}}>Pamela Roy choudhury</td>
                            </tr>
                            <tr style={{border:"2px solid black"}}>
                                <td style={{border:"2px solid black", padding:10, fontWeight:"bold"}}>Name</td>
                                <td style={{border:"2px solid black", padding:10}}></td>
                            </tr>
                            <tr style={{border:"2px solid black", padding:5}}>
                                <td style={{border:"2px solid black", padding:10, fontWeight:"bold"}}>Class</td>
                                <td style={{border:"2px solid black", padding:10}}></td>
                            </tr>
                            <tr style={{border:"2px solid black", padding:5}}>
                                <td style={{border:"2px solid black", padding:10, fontWeight:"bold"}}>Course Name</td>
                                <td style={{border:"2px solid black", padding:10}}></td>
                            </tr>
                            <tr style={{border:"2px solid black", padding:5}}>
                                <td style={{border:"2px solid black", padding:10, fontWeight:"bold"}}>Batch No.</td>
                                <td style={{border:"2px solid black", padding:10}}></td>
                            </tr>
                            <tr style={{border:"2px solid black", padding:5}}>
                                <td style={{border:"2px solid black", padding:10, fontWeight:"bold"}}>Subjects Choose</td>
                                <td style={{border:"2px solid black", padding:10}}></td>
                            </tr>
                            <tr style={{border:"2px solid black", padding:5}}>
                                <td style={{border:"2px solid black", padding:10, fontWeight:"bold"}}>Father's Name</td>
                                <td style={{border:"2px solid black", padding:10}}></td>
                            </tr>
                            <tr style={{border:"2px solid black", padding:5}}>
                                <td style={{border:"2px solid black", padding:10, fontWeight:"bold"}}>Phone No.</td>
                                <td style={{border:"2px solid black", padding:10}}></td>
                            </tr>
                            <tr style={{border:"2px solid black", padding:5}}>
                                <td style={{border:"2px solid black", padding:10, fontWeight:"bold"}}>Address</td>
                                <td style={{border:"2px solid black", padding:10}}></td>
                            </tr>
                            <tr style={{border:"2px solid black", padding:5}}>
                                <td style={{border:"2px solid black", padding:10, fontWeight:"bold"}}>Payment Type</td>
                                <td style={{border:"2px solid black", padding:10}}></td>
                            </tr>
                            <tr style={{border:"2px solid black", padding:5}}>
                                <td style={{border:"2px solid black", padding:10, fontWeight:"bold"}}>Monthly Fee</td>
                                <td style={{border:"2px solid black", padding:10}}></td>
                            </tr>
                            <tr style={{border:"2px solid black", padding:5}}>
                                <td style={{border:"2px solid black", padding:10, fontWeight:"bold"}}>Admission Fee</td>
                                <td style={{border:"2px solid black", padding:10}}></td>
                            </tr>
                            <tr style={{border:"2px solid black", padding:5}}>
                                <td style={{border:"2px solid black", padding:10, fontWeight:"bold"}}>Blood Group</td>
                                <td style={{border:"2px solid black", padding:10}}></td>
                            </tr>
                            <tr style={{border:"2px solid black", padding:5}}>
                                <td style={{border:"2px solid black", padding:10, fontWeight:"bold"}}>Catagory</td>
                                <td style={{border:"2px solid black", padding:10}}></td>
                            </tr>
                        </tbody>
                </table>
