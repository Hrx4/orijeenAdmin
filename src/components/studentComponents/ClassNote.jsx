            ...
            <div className="dContainer" style={{ marginTop: 40, margin: 20 }}>
                    ...
                    >
                        <div className="dBox">
                            ...
                            >
                                <Link className='crLink' to="/course1" style={{ fontSize: "25px", fontWeight: "bold", textDecoration:"none", paddingTop:"50px", paddingLeft:"85px" }}>Course 1</Link>
                        ...
                        <div className="dBox">
                            ...
                            >
                                <Link className="crlink" to="/updateprofile" style={{ fontSize: "25px", fontWeight: "bold",paddingTop:"50px",paddingLeft:"80px", textDecoration:"none", }}>Course 2 </Link>
