    ...
    return (
        <>
            <div>
                ...
                <div className='table-scroll' style={{width:"70%", overflowX:"scroll",overflowY:"scroll", padding:10,height:"100vh"}}>
        <table >
      <thead>
      
        <tr >
        <th style={{border:"1px solid black", padding:5}}>ID</th>
        <th style={{border:"1px solid black", padding:5}}>Yeart</th>
        <th style={{border:"1px solid black", padding:5}}>Month</th>
        <th style={{border:"1px solid black", padding:5}}>Payment Type</th>
        <th style={{border:"1px solid black", padding:5}}>Paid</th>
